...
def train_models(
    ...
    """
    # Create output directory (use absolute path to avoid nesting issues)
    ...
    lr_model = LogisticRegression(
        ...
        random_state=42,
        n_jobs=1  # Use single thread to avoid Windows multiprocessing issues
    )
    ...
    # Train main model: Gradient Boosting
    print("\n" + "=" * 60)
    print("TRAINING MAIN MODEL: GRADIENT BOOSTING")
    print("=" * 60)
    
    gb_model = GradientBoostingClassifier(
        n_estimators=50,  # Reduced for faster training (can increase later)
        learning_rate=0.1,
